...
if __name__ == '__main__':
    # delete_experiment(experiment_name='xception_p10-11_weight_14_labels_2e5', global_config_path="/home/soroosh/Documents/Repositories/chestx/central/config/config.yaml")
